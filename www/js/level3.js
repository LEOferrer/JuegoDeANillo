var level3 ={
	...
	game.scale.pageAlignHorizontally = true;
		...
		game.load.image("tres","img/level3.png");
		...
		game.load.spritesheet("pause","img/bots.png",108,94);
	...
	update:function() {
		...
		game.physics.arcade.overlap(bullets,dulo,sapul2);
		game.physics.arcade.overlap(bullets,back,tama2);
	...
	function fireBullet()
{
		...
		function sapul2(bullet,ring)
{
	gameOverText.text = "YOU MISSED THE RING\n         GAME OVER!";
   nxt = game.add.button(350,300,"retry",retry2);
    
        }
		
		function tama2(back,bullets)
{
	bullets.kill();
	nxt = game.add.button(600,30,"next",process.start2);
    
        }
		function retry2()
{
	game.state.add("level3" ,level3, true);
