var level4 ={
	...
	game.scale.pageAlignHorizontally = true;
		...
		game.load.image("tres","img/level4.png");
	...
	update:function() {
		...
		game.physics.arcade.overlap(bullets,dulo,sapul3);
		game.physics.arcade.overlap(bullets,back,tama3);
	...
	function fireBullet()
{
		...
		function sapul3(bullet,ring)
{
	gameOverText.text = "YOU MISSED THE RING\n         GAME OVER!";
   nxt = game.add.button(350,300,"retry",retry3);
    
        }
		
		function tama3(back,bullets)
{
	bullets.kill();
	nxt = game.add.button(600,30,"next",process.start4);
		...
		function retry3()
{
	game.state.add("level4" ,level4, true);
